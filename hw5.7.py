...
with open("test_7.json", "w", encoding="utf-8") as read_file:
    with open("test_7.txt", encoding="utf-8") as write_file:
        ...
        dump([dictionary, {"средняя прибыль": sum(average_profit_list) / len(average_profit_list)}],
